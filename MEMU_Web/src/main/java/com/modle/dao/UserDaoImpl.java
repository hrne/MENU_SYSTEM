...
//	}
	...
	public void save(User user) {
		...
		String sql = "INSERT INTO USER(NAME, EMAIL, ADDRESS, PASSWORD, NEWSLETTER, FRAMEWORK, SEX, HEIGHT, COUNTRY, SKILL) "
				+ "VALUES ( :name, :email, :address, :password, :newsletter, :framework, :sex, :height, :country, :skill)";
	...
	public void update(User user) {
		...
		String sql = "UPDATE USER SET NAME=:name, EMAIL=:email, ADDRESS=:address, " + "PASSWORD=:password, NEWSLETTER=:newsletter, FRAMEWORK=:framework, "
				+ "SEX=:sex, HEIGHT=:height, COUNTRY=:country, SKILL=:skill WHERE id=:id";
	...
	private SqlParameterSource getSqlParameterByModel(User user) {
		...
		paramSource.addValue("height", user.getHeight());
